...
-- MAGIC f=dbutils.fs.ls(schema_default_location)
-- MAGIC display(spark.sql(f"DESCRIBE SCHEMA {DA.schema_name}_default_location").collect())
...
-- MAGIC print(f"{DA.paths.datasets}/flight")
-- MAGIC f=dbutils.fs.ls(DA.paths.datasets)
-- MAGIC display(f)
